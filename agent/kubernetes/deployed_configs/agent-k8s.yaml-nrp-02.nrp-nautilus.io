...
metadata:
  annotations:
  labels:
    k8s-app: siterm-agent-nrp-02.nrp-nautilus.io
  name: siterm-agent-nrp-02.nrp-nautilus.io
spec:
  replicas: 1
  selector:
    matchLabels:
  ...
  template:
    ...
    spec:
      ...
      - configMap:
          ...
          name: sense-agent-nrp-02.nrp-nautilus.io
        name: sitermagent
      - name: agent-hostcert
        secret:
          secretName: sense-agent-nrp-02.nrp-nautilus.io
          items:
          - key: agent-hostcert
            path: hostcert.pem
          defaultMode: 0644
